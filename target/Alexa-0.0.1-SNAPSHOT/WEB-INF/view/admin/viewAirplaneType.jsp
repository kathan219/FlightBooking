								...
								<div class="card m-b-30">
									<div class="card-body">
										<table id="datatable-buttons"
											...
											<tbody>
											<c:forEach items="${manageAirplaneTypeList}" var="i" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${i.airplaneType}</td>
													<td>${i.economyClass}</td>
													<td>${i.businessClass}</td>
													<td>${i.firstClass}</td>
													<td>${i.total}</td>
													<td><a href="editAirplaneType?id=${i.id}"> <i class="mdi mdi-pencil font-20"></i>
													</a> <a href="deleteAirplaneType?id=${i.id}"> <i
