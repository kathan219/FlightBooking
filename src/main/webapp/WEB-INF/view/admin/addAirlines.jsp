...
<title>Admin | Add Airlines</title>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-title-box">
									...
									<h4 class="page-title">Add Airline</h4>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-12">
							<div class="card m-b-30">
								<div class="card-body">
									...
									<f:form class="" action="saveAirlines" method="post"
										modelAttribute="manageAirlinesVO">
										<div class="form-group">
											<label>Airline Name</label>
											<f:hidden path="id" />
											<f:input path="airlineName" class="form-control"
												required="required" placeholder="Airline Name" />
										</div>
										<div class="form-group">
											<label>Airline Description</label>
											<div>
												<f:textarea path="airlineDescription" class="form-control"
													rows="5" />
											</div>
										</div>
										<div class="form-group">
