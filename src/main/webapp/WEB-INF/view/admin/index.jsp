...
<link href="<%=request.getContextPath()%>/adminResources/css/morris.css" rel="stylesheet">
...
<body class="fixed-left">
				...
				<div class="page-content-wrapper">
					<div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-12 col-xl-4">
								<div class="card bg-white m-b-30">
									<img src="<%=request.getContextPath()%>/adminResources/image/wather.jpg" alt=""
										class="img-fluid">
												...
												<tbody>
													<tr>
														<td><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/avatar-2.jpg" alt="user"
															width="40"></td>
														<td><a href="javascript:void(0);">Ruby T. Curd</a></td>
														<td><img src="<%=request.getContextPath()%>/adminResources/image/us_flag.jpg"
													...
													<tr>
														<td><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/avatar-3.jpg" alt="user"
															width="40"></td>
														<td><a href="javascript:void(0);">William A.
																Johnson</a></td>
														<td><img src="<%=request.getContextPath()%>/adminResources/image/french_flag.jpg"
															alt="" style="width: 30px"></td>
														<td>$490</td>
														<td>24</td>
														<td><i class="mdi mdi-star text-warning"></i> <i
													...
													<tr>
														<td><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/avatar-4.jpg" alt="user"
															width="40"></td>
														<td><a href="javascript:void(0);">Bobby M. Gray</a></td>
														<td><img src="<%=request.getContextPath()%>/adminResources/image/spain_flag.jpg"
															alt="" style="width: 30px"></td>
														<td>$380</td>
														<td>19</td>
														<td><i class="mdi mdi-star text-warning"></i> <i
													...
													<tr>
														<td><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/avatar-5.jpg" alt="user"
															width="40"></td>
														<td><a href="javascript:void(0);">Robert N.
																Carlile</a></td>
														<td><img src="<%=request.getContextPath()%>/adminResources/image/russia_flag.jpg"
															alt="" style="width: 30px"></td>
														<td>$450</td>
														<td>30</td>
														<td><i class="mdi mdi-star text-warning"></i> <i
													...
													<tr>
														<td><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/avatar-6.jpg" alt="user"
															width="40"></td>
														<td><a href="javascript:void(0);">Ruby T. Curd</a></td>
														<td><img src="<%=request.getContextPath()%>/adminResources/image/italy_flag.jpg"
															alt="" style="width: 30px"></td>
														<td>$500</td>
														<td>40</td>
														<td><i class="mdi mdi-star text-warning"></i> <i
									...
									<div class="card-body new-user">
										...
										<ul class="list-unstyled mb-0 pr-3" id="boxscroll2"
											...
											<li class="p-3"><div class="media">
													<div class="thumb float-left">
														<a href="#"><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/avatar-5.jpg" alt=""></a>
													</div>
											...
											<li class="p-3"><div class="media">
													<div class="thumb float-left">
														<a href="#"><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/avatar-4.jpg" alt=""></a>
													</div>
													<div class="media-body">
														<p class="media-heading mb-0">
															William A. Johnson <i
											...
											<li class="p-3"><div class="media">
													<div class="thumb float-left">
														<a href="#"><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/avatar-3.jpg" alt=""></a>
													</div>
													<div class="media-body">
														<p class="media-heading mb-0">
															Robert N. Carlile<i
											...
											<li class="p-3"><div class="media">
													<div class="thumb float-left">
														<a href="#"><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/avatar-2.jpg" alt=""></a>
													</div>
													<div class="media-body">
														<p class="media-heading mb-0">
															Bobby M. Gray <i
											...
											<li class="p-3"><div class="media">
													<div class="thumb float-left">
														<a href="#"><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/avatar-1.jpg" alt=""></a>
													</div>
													<div class="media-body">
														<p class="media-heading mb-0">
															Ruby T. Curd <i
											...
											<li class="p-3"><div class="media">
													<div class="thumb float-left">
														<a href="#"><img class="rounded-circle"
															src="<%=request.getContextPath()%>/adminResources/image/avatar-6.jpg" alt=""></a>
													</div>
													<div class="media-body">
														<p class="media-heading mb-0">
															Robert N. Carlile <i
	...
	<script src="<%=request.getContextPath()%>/adminResources/js/skycons.min.js"></script>
