...
<title>Admin | View Airport</title>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-title-box">
									...
									<h4 class="page-title">View Airport</h4>
								</div>
							</div>
						</div>
								...
								<div class="card m-b-30">
									<div class="card-body">
										<table id="datatable-buttons"
											...
											<tbody>
												<c:forEach items="${manageAirportList }" var="i" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${ i.airportName}</td>
													<td>${ i.manageCityVO.cityName}</td>
													<td>${ i.airportType}</td>
													<td>${ i.airportDescription}</td>
													<td>
